...
const Search = () => {
    return (
        <div className='px-[30px] py-2 max-w-[1170px] mx-auto flex flex-col lg:flex-row justify-between gap-4 lg:gap-x-3 relative lg:-top-4 lg:shadow-1 lg:shadow-violet-400 bg-white lg:bg-transparent lg:backdrop-blur rounded-lg'>
            <select
                name="company"
                id="companies"
